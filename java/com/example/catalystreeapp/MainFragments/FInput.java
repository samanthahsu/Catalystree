...
public class FInput extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Toast.makeText(getActivity().getApplicationContext(), "Each section displayed here contains several sections in which data can be inputted", Toast.LENGTH_LONG).show();
