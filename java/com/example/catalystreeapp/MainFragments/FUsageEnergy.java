...
//        set view for chart
        ...
        Toast.makeText(getActivity().getApplicationContext(), "This graph displays your daily energy usage for each day of the week based on the data entered", Toast.LENGTH_LONG).show();
        Toast.makeText(getActivity().getApplicationContext(), "This graph displays your daily energy usage for each day of the week based on the data entered", Toast.LENGTH_SHORT).show();
